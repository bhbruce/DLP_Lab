...
class DDPG:
    ...
    def select_action(self, state, noise=True):
        ...
        with torch.no_grad():
            ...
            action = np.clip(action + self._action_noise.sample(), -1, 1)
            return action
    ...
    def _update_behavior_network(self, gamma):
        ...
        critic_loss = F.smooth_l1_loss(q_value, q_target)
        ...
        for t in itertools.count(start=1):
            ...
            if done:
                ...
                writer.add_scalar('Train/Ewma Reward', ewma_reward,
                                  total_steps)
                print('Step: {}\tEpisode: {}\tLength: {:3d}\tTotal reward: {:.2f}\tEwma reward: {:.2f}'
                      .format(total_steps, episode, t,
                              total_reward, ewma_reward))
                break
    env.close()
